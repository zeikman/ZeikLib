...
window.libGeneral = (function() {
    ...
    var libGeneral = {
        ...
        /*
         * Return context 'width' or 'height'
         * @memberof libGeneral
         * @instance
         * @param {String} view - Context 'width' or 'height'
         * @example
         * // max width/height of browser inner view
         * libGeneral.calViewPort('width');
         * libGeneral.calViewPort('height');
         */
        // calViewPort: function(view) {
        //     var viewPort = new $.jqx.response().viewPort;
        //     switch (view) {
        //         case 'width': return viewPort.width;
        //         case 'height': return viewPort.height;
        //         default: window.alert('libGeneral.calViewPort: Unknown view !'); break;
        //     }
        // },
        ...
        //     if (!source.type) {
        //         window.alert('Error:\nlibGeneral.dataAdapter(<type>)');
        //         return false;
        //     }
        //     if (!source.url) {
        //         window.alert('Error:\nlibGeneral.dataAdapter(<url>)');
        //         return false;
        //     }
        //
        //     var fields = [];
        ...
        //         datafields: fields,
        //         url: source.url,
        //         async: typeof source.url == 'boolean' ? source.url : true
        //     });
        // },
